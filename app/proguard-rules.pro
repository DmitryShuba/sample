...
# Keep models that retrofit can use
-keep public class com.dmitryshuba.sample.service.network.model.** {*;}
...
#    <init>(...);
#}
-keep class * implements androidx.arch.lifecycle.LifecycleObserver {
    <init>(...);
}
-keepclassmembers class * implements androidx.arch.lifecycle.LifecycleObserver {
    <init>(...);
}
...
-keep class * implements androidx.arch.lifecycle.GeneratedAdapter {<init>(...);}
# ViewModel's empty constructor is considered to be unused by proguard
-keepclassmembers class * extends androidx.arch.lifecycle.ViewModel {
    <init>(...);
}

# keep Lifecycle State and Event enums values
-keepclassmembers class androidx.arch.lifecycle.Lifecycle$State { *; }
-keepclassmembers class androidx.arch.lifecycle.Lifecycle$Event { *; }
# keep methods annotated with @OnLifecycleEvent even if they seem to be unused
# (Mostly for LiveData.LifecycleBoundObserver.onStateChange(), but who knows)
-keepclassmembers class * {
    @androidx.arch.lifecycle.OnLifecycleEvent *;
}
...
-keepclasseswithmembernames interface androidx.**
-dontobfuscate
